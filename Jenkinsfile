pipeline {
    ...
    environment {
        DOCKER_IMAGE_NAME = 'mohamed329/chambre-mohamed'
    ...
    stages {
        stage('Git') {
            steps {
                ...
                git branch: 'modulechambre-mohamedajilii', url: 'https://github.com/houssem112c/devops-.git'
            }
        }
    ...
    steps {
        ...
        stage('Build & Push Docker Image') {
            steps {
                script {
                    dir("${WORKSPACE}") {
                        sh "docker build -t mohamed329/chambre-mohamed:latest ."
                    sh "docker push mohamed329/chambre-mohamed:latest"
                    }
                }
            }
        }
